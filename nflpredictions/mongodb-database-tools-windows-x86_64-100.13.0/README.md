...
.\mongodb-database-tools-windows-x86_64-100.13.0\bin\mongoexport.exe --uri=mongodb+srv://pcsm.lwx4u.mongodb.net/pcsm --port=27017 --collection=games --username=pcsm-user --password= --out=2022-games-week13.csv --type=csv --query='{"gameWeek": {"$lt": 16},"year":2022,"season": "reg"}' --fieldFile=games-fieldsFile.txt
